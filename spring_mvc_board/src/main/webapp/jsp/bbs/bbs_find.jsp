      ...
      <td>
         <div>${list.bbs_readcount }</div>
			...
			<tr class="h30 lime center btn">
				...
				<c:if test="${page > 1 }">
					<a href="./bbs_find_ok.nhn?page=${page-1 }&find_field=${find_field}&find_name=${find_name}">이전</a>
				</c:if>
				...
				<c:forEach var="a" begin="${startpage }" end="${endpage }">
					...
					<c:if test="${a!=page }">
						<a href="./bbs_find_ok.nhn?page=${a }&find_field=${find_field}&find_name=${find_name}">${a }</a>
					</c:if>
				</c:forEach>
				...
				<c:if test="${page < maxpage }">
					<a href="./bbs_find_ok.nhn?page=${page+1 }&find_field=${find_field}&find_name=${find_name}">다음</a>
