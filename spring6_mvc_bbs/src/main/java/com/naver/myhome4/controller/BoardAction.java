...
import com.naver.myhome6.dao.BoardDAOImpl;
...
public class BoardAction {
	...
	/*
	  @RequestMapping 메서드를 실행하는 과정에서 익셉션이 발생할 때 직접 인셉션 처리를 하고 싶을때
	  @ExceptionHandler를 사용합니다.
	  익셉션 타입을 @ExceptionHandler 애노테이션 값으로 지정하면 됩니다.
	  RuntimeException.class : 익셉션 타입
	...
	*/
	...
	// 응답 코드 전송하고자 할 경우
	// error/ exception2 페이지에서 <%page isErrorPage="true"%> 사용해야 합니다.
	@ExceptionHandler(RuntimeException.class)
	public String handelException(HttpServletResponse response) {
