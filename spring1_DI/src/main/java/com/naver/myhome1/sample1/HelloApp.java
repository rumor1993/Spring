...
/*
	...
	HelloApp 클래스에서 MessageBeanEn 클래스를 직접 인스턴스를 생성하여
	say 메서드를 호출하고 있습니다.
	...
	만일 HelloApp 클래스에서 MessageBeanEn 클래스 대신 다른 클래스 (MessageBeanKo)를 
	사용할 경우에 (MessageBeanKo 클래스는 MessageBeanEn 클래스와 같은 기능을 수행하는 메서드가 존재합니다.
	이 클래스의 메서드는 MessageBeanEn 클랫의 메서드와 다른 이름으로 사용되고 있습니다.
	그래서 MessageBeanKo 클래스를 실행하기 위해서는 아래의 26-27라인 처럼 코드를 수정해야 합니다.
